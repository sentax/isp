      ...
      .resizable({
        ...
        listeners: {
          move(event) {
            ...
            target.style.width = event.rect.width - 18 + 'px';
            target.style.height = event.rect.height - 18 + 'px';
            ...
            target.setAttribute('data-x', Object.assign({}, x));
            target.setAttribute('data-y', Object.assign({}, y));
...
function dragMoveListener(event) {
  var target = document.getElementById('isp-window-' + event.target.getAttribute('data-id-index'))
